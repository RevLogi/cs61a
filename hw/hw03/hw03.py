...
def digit_distance(n):
    ...
    if n < 10:
        ...
        return abs(second - last) + digit_distance(n // 10)
...
def interleaved_sum(n, f_odd, f_even):
    ...
    def helper1(i):
        if i > n:
            ...
            return f_odd(i) + helper2(i + 1)

    def helper2(i):
        if i > n:
            return 0
        else:
            return f_even(i) + helper1(i + 1)
...
def count_dollars(total):
    ...
    def count_helper(t,n):
        if t == 0:
            ...
            return count_helper(t - n, n) + count_helper(t, next_smaller_dollar(n))

    return count_helper(total, largest_dollar(total))
